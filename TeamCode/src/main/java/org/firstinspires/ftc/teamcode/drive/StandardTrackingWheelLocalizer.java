...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.94511425; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6; // in; offset of the lateral wheel
    /* Lines 37-38 in StandardTrackingWheelLocalizer.java */
    public static double X_MULTIPLIER = 1.04502266; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.04012041; // Multiplier in the Y direction
