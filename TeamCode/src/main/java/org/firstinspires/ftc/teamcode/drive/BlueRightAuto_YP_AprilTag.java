...
@Autonomous(name = "Comp: Blue Right P&Y - AT", group = "Blue Auto - YP")
public class BlueRightAuto_YP_AprilTag extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (detector.getLocation()){
            case LEFT:
                ...
                TrajectorySequence toParkLeft = drive.trajectorySequenceBuilder(lineYellow.end())
            ...
            case CENTER:
                ...
                TrajectorySequence toParkCenter = drive.trajectorySequenceBuilder(lineYellow.end())
                        .lineTo(new Vector2d(46,30))
                        .build();
            ...
            case RIGHT:
                ...
                TrajectorySequence toParkRight = drive.trajectorySequenceBuilder(lineYellow.end())
                        .lineTo(new Vector2d(46,30))
                        .build();
